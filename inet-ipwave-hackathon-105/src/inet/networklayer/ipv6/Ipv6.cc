...
//    packet->addTagIfAbsent<MacAddressReq>()->setDestAddress(macAddr);
    ...
    packet->addTagIfAbsent<DispatchProtocolInd>()->setProtocol(&Protocol::ipv6);
//    std::cout << "MAC DEST ADDR: "<< packet->getTag<MacAddressReq>()->getDestAddress()<<"," <<macAddr<< endl;
...
//            std::cout <<"get next hop from neighborRoute"<<endl;
...
//                std::cout <<"set next hop as default router"<<endl;
