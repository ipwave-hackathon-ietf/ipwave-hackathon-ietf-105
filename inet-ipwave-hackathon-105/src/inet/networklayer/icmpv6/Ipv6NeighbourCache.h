...
//            neighborAddr(addr), macAddr(mac), relayAddr(relay), hopDistance(hop) {}
  ...
  public:
    ...
    virtual Neighbour *replaceNeighbour(const Ipv6Address& globalAddr, const Ipv6Address& linkLocalAddr, int interfaceID, MacAddress macAddress, simtime_t registLifetime, const Ipv6Address& relayAddr);
//    virtual Neighbour *replaceNeighbourRoutingTable(const Ipv6Address& linkLocalAddr, const Ipv6Address& globalAddr, int interfaceID);
    // END
