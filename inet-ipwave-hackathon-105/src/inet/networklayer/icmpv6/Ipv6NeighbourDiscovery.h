...
//    typedef Ipv6NeighbourCache::MultihopDadEntry MultihopDadEntry;    // for convenience
  ...
  public:
    //XIANG ZHONG 19.05.20 Change neighbourCache and rt6 from protected to public
    Ipv6NeighbourCache neighbourCache;
    Ipv6RoutingTable *rt6 = nullptr;

    //XIANG ZHONG 19.05.24 For simulation
    simtime_t dadStartTime;
    simtime_t dadFinishTime;
    int numRAsent = 0;
  ...
  protected:
    ...
    //XIANG ZHONG test // Change neighbourCache to public
//    Ipv6NeighbourCache neighbourCache;
...
//    virtual void addNeighborAsRouter(Packet *packet,InterfaceEntry *ie, const Ipv6NeighbourAdvertisement *na);
